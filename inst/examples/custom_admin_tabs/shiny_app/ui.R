...
secure_ui(
  ...
  custom_admin_ui = list(
    menu_items = source("admin/custom_admin_menu_items.R", local = TRUE)$value,
    tab_items = source("admin/custom_admin_tab_items.R", local = TRUE)$value
  )
)
