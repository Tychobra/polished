...
NOTE: when passing your custom module UI as the `sign_in_page_ui` argument in the `secure_ui` function, you **must** use "sign_in" as the UI module's ID (as shown in the example below).
